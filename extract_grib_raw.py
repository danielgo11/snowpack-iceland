...
SITES: Dict[str, Site] = {
    "vestfj": Site("vestfj", 1, 85, 212, 65.928064, -23.136375, 651.6),
    "nord": Site("nord", 2, 183, 241, 65.995650, -18.648705, 730.4),
    "austfj": Site("austfj", 3, 295, 238, 65.303028, -14.086696, 767.1),
    "oddskard": Site("oddskard", 4, 304, 227, 65.0680046, -13.9022296, 613.2),
}
